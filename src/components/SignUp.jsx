...
function SignUp() {
  ...
  let handleSignup = async (e) => {
    ...
    if (confirmPassword.trim() === "") {
      ...
      setConfirmPasswordRes("Password doesn't match with confirm password");
      return;
    }
  ...
  return (
    <>
      <div className="container">
        ...
        <h1 style={{ textAlign: "center", color: "var(--theme)" }}>
          Expenses Tracker
        </h1>
        ...
        <Form>
          <div className="div-label">
            ...
            {confirmPasswordRes && (
              <p className="text-danger">{confirmPasswordRes}</p>
            )}
          </div>
          <br />
          <div className="login-button">
            <Button
              ...
              style={{ color: "var(--white)", backgroundColor: "var(--theme)" }}
              disabled={submit}
            >
              Signup
            </Button>
